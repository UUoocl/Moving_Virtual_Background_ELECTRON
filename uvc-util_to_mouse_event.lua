...
function script_properties()
    ...
    local property_list = obs.obs_properties_add_list(properties, "source_name", "Text Source (In Scene)",
...
function run_command()
    ...
    --prepare PTZ data to be sent as a mouse event the the browser 
	...
	obs.obs_source_send_mouse_wheel(obs.obs_get_source_by_name("PSV-js"), mouseevent,-100,10)
	obs.script_log(obs.LOG_INFO, "sent mouse wheel event ")

	--obs.obs_source_send_mouse_move(obs.obs_get_source_by_name("BrowserListener"), mouseevent, false)
	--obs.obs_source_send_mouse_wheel(obs.obs_get_source_by_name("BrowserListener"), mouseevent,50,10)
end
